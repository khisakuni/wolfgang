import reducer, { addTimeSignature, deleteTimeSignature, types, initialState } from './time-signatures'
...
describe('reducers/time-signatures', () => {
  ...
  describe('reducer', () => {
    ...
    it('adds time signature when ADD_TIME_SIGNATURE', () => {
      ...
      expect(reducer(initialState, addTimeSignature(timeSignature))).toEqual(expected)
    })
    ...
    it('deletes time signature when DELETE_TIME_SIGNATURE', () => {
      ...
      expect(reducer(state, deleteTimeSignature(timeSignature))).toEqual(expected)
    })
  })
})
